...
\vspace{.05in}
\begin{tabular}{@{}p{3in}p{3.4in}}
125 South Webster Street             & {\it Voice:}  (608) 266-5186 \\            
Wisconsin Department of Public Instruction   & {\it Fax:}    (608) 263-6448  \\         
State of Wisconsin  & {\it E-mail:}  jared.knowles@dpi.wi.gov\\       
Madison, WI  53707 USA  & {\it www:} \url{www.dpi.wi.gov} \\     
\end{tabular}

\vspace{-.1cm}
\section{\sc Research Interests}
Education governance, federalism, public policy, the bureaucracy, dropout early warning systems, applied statistical models, analysis of administrative records, applied data visualization
...
\item Institute of Education Sciences (IES) Pre-Doctoral Training Program Fellow
\end{list2}
\vspace*{.05in}
...
% Recipient of University of Wisconsin-Madison Political Science Department 2012 Summer Initiative Research funds
% 
% \vspace*{-2.5mm}
...
% 
% \vspace{-.3cm}
% {\em Graduate Student} \hfill {\bf September 2008 - present}\\
