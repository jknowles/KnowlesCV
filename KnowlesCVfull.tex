...
[Under review at the Journal of Education Data Mining]
...
% Clune, William, Bradley Carl, Kurt Kiefer, and Jared Knowles. 2013. \emph{The Wisconsin Partnership for Actionable Research in Education: Establishing Long-term Capacity for Linking Research to Education Decision Making.} A proposal to to the Institute of Education Sciences Researcher-Practitioner Partnerships Competition (CFDA 84.305) [pending]
...
\item Languages:  R, Python, SQL, JavaScript, HTML5, CSS
\item R Packages: Creator \textbf{eeptools}, deep experience with caret, ggplot2, data.table, knitr, lme4, and more
\item Applications: git, \LaTeX, Beamer, Processing, common Windows
