...
Knowles, Jared E. and Carl Frederick. (2015). merTools: Tools for Analyzing Mixed Effect Regression Models. R package version 0.9. \url{http://CRAN.R-project.org/package=merTools}

Knowles, Jared E. and Zach Mayer. (2015). caretEnsemble: Ensembles of Caret Models. R package version 1.0. 
\url{http://CRAN.R-project.org/package=caretEnsemble}
...
Knowles, Jared E. (2014). Knowles R Bootcamp. figshare. \url{http://dx.doi.org/10.6084/m9.figshare.1150042}
...
Knowles, Jared and Deven Carlson. ``The Effect of English Proficiency Classification on Future Outcomes: Evidence from a Statewide Discontinuity.'' [Revise and Resubmit at the 
...
Strategic Data Project Cohort 5 Faculty Advisor
...
\item R Packages: Creator \textbf{eeptools}, deep experience with caret, ggplot2, data.table, knitr, lme4, and more
